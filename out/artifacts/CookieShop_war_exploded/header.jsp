            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <ul class="multi-column-dropdown">
                                           ...
                                           <%--遍历全部类目--%><%--存在bug，后台必须刷新类目管理，下面的代码才能获取全部类目--%>
                    ...
                    <c:choose><c:when test="${empty user }">
                        ...
                        <li><a href="${pageContext.request.contextPath }/order_list" <c:if test="${param.flag==5 }">class="active"</c:if>>我的订单</a></li><%--404--%>
                        <li><a href="${pageContext.request.contextPath}/user_center.jsp" <c:if test="${param.flag==4 }">class="active"</c:if>>个人中心</a></li>
                        <li><a href="user_logout" >退出</a></li><%--404——使用相对路径，绝对路径都不行--%><%--但是直接使用user_logoutwo可以--%><%--普通路径--%>
                    </c:otherwise>
                    </c:choose>
